...
struct HfTreeCreatorOmegacToOmegaPi {
  ...
  void processDataFull(MyEventTable const& collisions, MyTrackTable const&,
                       soa::Join<aod::HfCandOmegaC, aod::HfSelOmegacToOmegaPi, aod::HfMlSelOmegacToOmegaPi> const& candidates)
  {
  ...
  PROCESS_SWITCH(HfTreeCreatorOmegacToOmegaPi, processDataFull, "Process data with full information", true);
  ...
  PROCESS_SWITCH(HfTreeCreatorOmegacToOmegaPi, processMcFull, "Process MC with full information", false);
  ...
  PROCESS_SWITCH(HfTreeCreatorOmegacToOmegaPi, processDataLite, "Process data and produce lite table version", false);
  ...
  PROCESS_SWITCH(HfTreeCreatorOmegacToOmegaPi, processMcLite, "Process MC and produce lite table version", false);
